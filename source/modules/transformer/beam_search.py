...
from source.modules.transformer import beam_search_v1 as v1
...
class SequenceBeamSearchV2(v1.SequenceBeamSearch):
  ...
  def search(self, initial_ids, initial_cache):
    ...
    # 2.0 changes torch.where behavior. Should make parameters broadcastable.
    finished_cond = torch.reduce_any(finished_flags, 1, name="finished_cond")
